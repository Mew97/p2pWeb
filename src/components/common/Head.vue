<template>
  <header>
    ...
    <div class="header min-width">
      <div class="container">
        <div class="fn-left logo"> <a class="" href="index.html"> <img src="http://mycanvas.oss-cn-shanghai.aliyuncs.com/HTML/images/%E5%9B%BE%E7%89%871.png"  title="" style="width: 58%; height: 179%"> </a> </div>
        <ul class="top-nav fn-clear">
          <li class="on"> <a href="index.html">首页</a> </li>
          <li> <a href="list.html" class="">我要投资</a> </li>
          <li> <a href="" @click.prevent="toHelp">安全保障</a> </li>
